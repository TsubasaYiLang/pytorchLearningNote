...
class Net(torch.nn.Module):
    def __init__(self):
        ...
        self.conv1 = torch.nn.Conv2d(1, 10, kernel_size=5)  # 输入channel 输出channel
        self.conv2 = torch.nn.Conv2d(10, 20, kernel_size=5)
        self.pooling = torch.nn.MaxPool2d(2)  # 再定义一个池化层
        self.fc = torch.nn.Linear(320, 10)  # 最后是我们做分类用的线性层
